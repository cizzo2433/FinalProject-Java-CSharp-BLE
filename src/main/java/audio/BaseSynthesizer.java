...
/**
 * Abstract class with methods for language detection and String parsing to ensure that a valid API
 * request is sent by subclass
 */
public abstract class BaseSynthesizer {
	 ...
	 * Should only be called if the text being converted to an InputStream is larger than the
	 * token limit specified in child class.
	 * 
	 ...
	 */
	protected InputStream getMP3Data(List<String> synthText) throws IOException {

		//Uses an executor service pool for concurrency. Limit to 1000 threads max because that seems like a lot
	 ...
	 */
	protected String detectLanguage(String text) throws IOException {
